<template><v2container :wid="`root`"><el-row class="V2ContainerBlock" style="height:100%;width:100%;" key="0"><v2container id="1563783431348" :wid="`1563783431348`" :index="0" :pid="`root`"><el-row class="V2ContainerBlock borderBox dashBorder" style="height:10%;width:100%;" key="0"><v2-component-text class="V2Widget" id="1563783423809" :wid="`1563783423809`" :index="0" :pid="`1563783431348`"></v2-component-text></el-row><el-row class="V2ContainerBlock borderBox dashBorder" style="height:90%;width:100%;" key="1"><v2-component-table class="V2Widget" id="1563785672702" :wid="`1563785672702`" :index="1" :pid="`1563783431348`"></v2-component-table></el-row></v2container></el-row></v2container></template>
<script>
