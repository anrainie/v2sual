...
bankCardListData:[
        ...
        if(res.data.retType === 'SUCCESS'){
            ctx.bankCardListData = res.data.jsonData;
	  ...
	  status:true,
		...
		cancelCallback:(e) => {
			console.log('点击取消')
                ...
                /*overview*/
                    (async()=>{    const t4 = ctx.queryBanCardList();
})();
                /*overview over*/
