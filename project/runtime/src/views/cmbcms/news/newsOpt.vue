    ...
    content: ''
        ...
        this.$message({
                ...
                created(){
                    ...
                    /**bind**/ctx.$store.commit("registerBind",{ vueObj:this, data:this.newsOptLabel, dataStr:"newsOptLabel", wid:1564135738619, modelKey:"text" });
ctx.$store.commit("registerBind",{ vueObj:this, data:this.news.title, dataStr:"news.title", wid:1564135742836, modelKey:"value" });
ctx.$store.commit("registerBind",{ vueObj:this, data:this.news.content, dataStr:"news.content", wid:1564135762399, modelKey:"value" });/**bind over**/
                },
                beforeMount(){
                    let ctx = this;
