<template>
  <div class="d-roll-wrapper"  style="height:160px">
    <ul
      ref="list"
      class="d-roll-list"
      style="height:160px"
...
<style>
  ...
  .d-roll-list .d-roll-item:nth-last-child(4n)::before,
 ...
 .d-roll-list .d-roll-item:nth-last-child(4)::before{
     content: '万';
 }
  .d-roll-list .d-roll-item:nth-last-child(8)::before{
     content: '亿';
 }
  .d-roll-list .d-roll-item:nth-last-child(0)::before{
     content: '笔';
 }
 .d-roll-list .d-roll-item:nth-last-child(4n)>.d-roll-bar{
   margin-left:100px;
 }
.d-roll-list .d-roll-item:first-child:before{
  content: '';
}
  .num-bg{
