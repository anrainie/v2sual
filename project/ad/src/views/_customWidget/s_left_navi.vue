<template><v2-ctn-xy :wid="`root`"><v2-component-image class="V2Widget" id="1566903798862" :wid="`1566903798862`" :index="0" :pid="`root`"></v2-component-image><v2-component-text class="V2Widget" id="1566903851862" :wid="`1566903851862`" :index="1" :pid="`root`"></v2-component-text></v2-ctn-xy></template>
<script>
...
selected:{default:()=>{return `false`}}
                ...
                computed:{
        img(){
          return this.selected?'img/s_navi_item2.png':'img/s_navi_item1.png';
        }
        },
                beforeCreate(){
                    let ctx = this;
                ...
                created(){
                    ...
                    /**bind**/ctx.$store.commit("registerBind",{ vueObj:this, data:this.title, dataStr:"title", wid:1566903851862, modelKey:"text" });/**bind over**/
                },
                beforeMount(){
                    let ctx = this;
