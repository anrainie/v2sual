...
<script>
            ...
            import v2ComponentS_number_text2 from '@/views/_customWidget/s_number_text2.vue';import v2ComponentS_background from '@/views/_customWidget/s_background.vue'
            export default{
                data(){
                    return{
  ...
  series: [
    ...
    },
    {
      ...
      data: [16, 16, 16, 16, 16]
                ...
                mixins:[root,mixins],
                components:{v2ComponentS_number_text2,v2ComponentS_background},
                methods:{},
                watch:{},
                computed:{},
                beforeCreate(){
