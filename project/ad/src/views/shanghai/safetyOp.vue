  ...
  series: [
    ...
    },
    {
      ...
      data: [13.7, 13.7, 13.7]
                ...
                mixins:[root,mixins],
                components:{v2ComponentS_number1,v2ComponentS_number_text2,v2ComponentS_background},
                methods:{
                  _source_init(){
                    let ctx = this;
