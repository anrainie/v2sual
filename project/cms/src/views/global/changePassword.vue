			...
			changePassword:function(){
				this.$refs.changePwdForm.validate(valid => {
					if (valid) {
						...
						global.$axios.put(`${global.$axios.server}/changePassword.do?ctoken=${localStorage.getItem('ctoken')}&oldPassword=${params.oldPassword}&newPassword=${params.newPassword}&repeatNewPassword=${params.repeatNewPassword}`).then(res => {
						...
						// this.$putAxios(
						// 	`${global.$axios.server}/changePassword.do`,
						// 	params
						// ).then(res => {
						// 	this.addLoading = false;
						// 	if (res.status) {
