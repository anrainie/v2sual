<template>
    <div :class="classes" v-clickoutside="handleClose">
        <div ref="reference" @click="toggleVisible($event)" :class="wrapClasses">
...
<script>
    ...
    import { oneOf, getElementViewTop, getElementViewLeft} from '../../utils/assist';
    ...
    export default {
        ...
        methods: {
            ...
            toggleVisible ($event) {
                ...
                if (document.body.offsetHeight - getElementViewTop($event.target) < 321){
                    if (document.body.offsetWidth - getElementViewLeft($event.target) < 256){
                        this.placement = 'left-end';
                    }/*  else if (getElementViewLeft($event.target) < 256) {
                        this.placement = 'right-end';
                    } */ else {
                        this.placement = 'right-end';
                    }
