    ...
    <div :class="wrapClasses">
        <template v-if="type !== 'textarea'">
            ...
            <i class="ivu-icon" :class="['ivu-icon-' + icon, prefixCls + '-icon', prefixCls + '-icon-normal']"
               v-if="icon" @click="handleIconClick"></i>
            ...
            <input
                    ...
                    @input="handleInput"
                    @change="handleChange">
            <i v-if="!validateDanger" class="aui-danger-icon aui aui-round_warming" @mouseover="clickIcon($event)"></i>
            <!--<div class="aui-danger-text" v-if="!validateDanger" v-show="showIcon">-->
                <!--<span>{{validateObj.errorMessage||'校验错误'}}</span>-->
            <!--</div>-->
            ...
            wrapClasses () {
                return [
                    `${prefixCls}-wrapper`,
                    {
                        ...
                        [`aui-danger-ctn`]: !this.validateDanger
                    }
                ];
            },
//            validateDanger(){
//
//                if(this.currentValue && this.validateObj && this.validateObj.type){
//
//                    return (new RegExp(this.validateObj.type)).test(this.currentValue);
//                }else{
//                    return true;
//                }
//
