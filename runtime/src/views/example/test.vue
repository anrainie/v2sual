...
export default {
                                  ...
                                  style: [
                                    {
                                      desp: "按钮样式",
                                      cssAttrs:
                                        "background-color width height color",
                                    ...
                                    },
                                    {
                                      desp: "按钮hover",
                                      cssAttrs:
                                        "background-color border-width border-color color ",
                                      name: "hoverBtn"
                                    },
                                    {
                                      desp: "按钮激活",
  ...
  methods: {
    click_0_1559272065466() {
      ...
      /**overView click_0_1559272065466**/ (async () => {
        const t1 = await alert("hahahahah");
      })();
      /**overView over**/
    }
  },
  ...
  beforeCreate() {
    ...
    /**overView over**/ /**bind**/ this.$store.commit("bind", {
      vueObj: this,
      data: this.user,
      dataStr: "this.user",
      wid: 1559214393146,
