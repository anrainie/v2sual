<template>
  <v2container :wid="`root`">
    <el-row class="V2ContainerBlock" style="height:100%;width:100%;" key="0">
      <v2container id="1561105983574" :wid="`1561105983574`" :index="0" :pid="`root`">
        <el-row
        ...
        >
          ...
          >
            <template v-slot="scope">
              <v2-form-input
                class="V2Widget"
                :id="`1561111620055-${scope._key}`"
                :wid="`1561111620055-${scope._key}`"
                :index="scope._key"
                :pid="`1561111620055`"
                :cpttype="`loopItem`"
                :$item="scope._item"
...
import v2ComponentTest1 from "@/views/_customWidget/test1.vue";
export default {
  data() {
    return {
      CONTENT: {
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  href: "v2-component-test1",
                  cptpath: "\\src\\views\\_customWidget\\test1.vue",
                  children: [],
                  events: {},
                  id: 1561361787909,
                  pid: 1561105983574
